...
import sickle from '../images/sickle.jpeg'
import BackToDashBoard from './BackToDashBoard';
import AssessmentGarden from './AssesmentGarden';
  ...
  return (
    <div>
      ...
      <div  id="section2" className="header">
        <h3>Benifits of  Green Farming?</h3>
            <ul>
    ...
    <div className="table-of-contents">
        ...
        <a href="#section1">What is Green Farming?</a>
        <a href="#section2">Benefits of Green Farming</a>
        <a href="#section3">Tree Plantation</a>
        <a href="#section4">Herb Plantation</a>
        <a href="#section5">Root Plantation</a>
        <a href="#tools">Tools for Farming</a>
